...
const groupOrderPrefix = "GROUP_ORDER/";
...
export const productContants = {
  ...
  GET_PRODUCTS_BY_TRADEMARK: `${productPrefix}GET_PRODUCTS_BY_TRADEMARK`,
  GET_PRODUCTS_BY_TRADEMARK_SUCCESS: `${productPrefix}GET_PRODUCTS_BY_TRADEMARK_SUCCESS`,
...
export const cartContants = {
  ...
  OPEN_CART: `${cartPrefix}OPEN_CART`,
  CLOSE_CART: `${cartPrefix}CLOSE_CART`,
};
...
export const authenticateContants = {
  ...
  UPDATE_SIDEBAR: `${authenticatePrefix}UPDATEP_SIDEBAR`,
...
export const groupOrerConstants = {
  CREATE_GROUP_ORDER_SUCCESS: `${groupOrderPrefix}CREATE_GROUP_ORDER_SUCCESS`,
  GET_THE_GROUP_ORDER_ITEM: `${groupOrderPrefix}GET_THE_GROUP_ORDER_ITEM`,
  CLEAR_INFO: `${groupOrderPrefix}CLEAR_INFO`,
  PRELOAD_CHECK_SUCCESS: `${groupOrderPrefix}PRELOAD_CHECK_SUCCESS`,
};

export const themeConstants = {
  SET_MODE: `${themePrefix}SET_MODE`,
  SET_COLOR: `${themePrefix}SET_COLOR`,
  GET_THEME: `${themePrefix}GET_THEME`,
};
